...
@Component({
  ...
  templateUrl: './lightning-node-channels.component.html',
  styleUrls: ['./lightning-node-channels.component.scss'],
  changeDetection: ChangeDetectionStrategy.OnPush
})

export class LightningNodeChannelsComponent implements OnInit {
